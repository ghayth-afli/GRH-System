                ...
                if (jwtUtils.validateJwtToken(jwt)) {
                    ...
                    UsernamePasswordAuthenticationToken authentication =
                            new UsernamePasswordAuthenticationToken(
                                    user,  // Pass the user object instead of username
                                    null,
                                    authorities
                            );

                    // Set authentication in both security context and header accessor
                    SecurityContextHolder.getContext().setAuthentication(authentication);
                    accessor.setUser(authentication);  // This is crucial for WebSocket
                }
            }
        }
        return message;
